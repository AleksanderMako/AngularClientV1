 ...
 */
export class FlightTableDataSource extends DataSource<Flight> {
  data: Flight[] = this.tableData;
  private loadingSubject = new BehaviorSubject<boolean>(false);

  public loading$ = this.loadingSubject.asObservable();
  constructor(private paginator: MatPaginator, private sort: MatSort, private tableData: Flight[]) {
    super();
  }
